<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:45:"./application/admin/template/images\index.htm";i:1589434587;s:65:"D:\phpStudy\WWW\bjsh\application\admin\template\public\layout.htm";i:1589434587;s:63:"D:\phpStudy\WWW\bjsh\application\admin\template\article\bar.htm";i:1589434587;s:69:"D:\phpStudy\WWW\bjsh\application\admin\template\archives\tags_btn.htm";i:1589434587;s:65:"D:\phpStudy\WWW\bjsh\application\admin\template\public\footer.htm";i:1589434587;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form class="navbar-form form-inline" action="<?php echo url('Images/index'); ?>" method="get" onsubmit="layer_loading('正在处理');">
                    ...
                    <?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
                        <tr>
                            ...
                            <td class="sort">
                                <div class="w60 tc">
                                    <?php if(is_check_access(CONTROLLER_NAME.'@edit') == '1'): ?>
                                    <input style="text-align: center;" type="text" onchange="changeTableVal('archives','aid','<?php echo $vo['aid']; ?>','sort_order',this);"  size="4"  value="<?php echo $vo['sort_order']; ?>" />
                                    <?php else: ?>
        ...
        <div class="tDiv">
            <div class="tDiv2">
                ...
                <div class="fbutton">
                    <a href="<?php echo url('Images/add', array('typeid'=>\think\Request::instance()->param('typeid'))); ?>">
                        <div class="add" title="新增图集">
                            <span class="red"><i class="fa fa-plus"></i>新增图集</span>
                        </div>
                    </a>
                </div>
                <?php endif; ?>
