<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:29:"./template/pc/view_images.htm";i:1589434577;s:43:"D:\phpStudy\WWW\bjsh\template\pc\header.htm";i:1590030269;s:43:"D:\phpStudy\WWW\bjsh\template\pc\footer.htm";i:1589434577;}*/ ?>
<!DOCTYPE html>
<html>
 <head> 
       ...
       <section class="ey-showimg-con"> 
        <div class="ey-showimg-list fngallery cover text-xs-center" id="ey-imgs-slick"> 
         ...
         <div class="slick-slide"> 
          <a href="<?php echo $field['image_url']; ?>" class="lg-item-box"  data-exthumbimage="<?php echo $field['image_url']; ?>"> <img src="<?php echo $field['image_url']; ?>" class="img-fluid" alt="<?php echo $field['title']; ?>" /> </a> 
         </div> 
         <?php ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>
        </div> 
       </section> 
