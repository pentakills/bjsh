<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:45:"./application/admin/template/product\edit.htm";i:1589434587;s:65:"D:\phpStudy\WWW\bjsh\application\admin\template\public\layout.htm";i:1589434587;s:70:"D:\phpStudy\WWW\bjsh\application\admin\template\field\addonextitem.htm";i:1589434587;s:65:"D:\phpStudy\WWW\bjsh\application\admin\template\public\footer.htm";i:1589434587;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo url('Product/edit'); ?>" method="post">
        ...
        <?php if(!empty($shopConfig['shop_open']) && 1 == $shopConfig['shop_open']): ?>
            ...
            <?php else: if(empty($IsSame) || (($IsSame instanceof \think\Collection || $IsSame instanceof \think\Paginator ) && $IsSame->isEmpty())): ?>
                ...
                <?php endif; endif; endif; if(!empty($ifcontrolRow['users_price'])): ?>
            <dl class="row">
                <dt class="tit">
