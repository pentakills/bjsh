<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:30:"./template/pc/lists_images.htm";i:1589434577;s:43:"D:\phpStudy\WWW\bjsh\template\pc\header.htm";i:1590030269;s:43:"D:\phpStudy\WWW\bjsh\template\pc\footer.htm";i:1589434577;}*/ ?>
<!DOCTYPE html>
<html>
 <head> 
     ...
     <ul class="blocks-100 blocks-md-2 blocks-lg-4 blocks-xxl-4  no-space ey-pager-ajax imagesize ey-img-list"> 
      ...
      <li class="widget "> 
       <div class="cover overlay overlay-hover"> 
        <a href="<?php echo $field['arcurl']; ?>" title="<?php echo $field['title']; ?>" class="btn btn-outline btn-inverse ey-img-showbtn"> <img class="cover-image overlay-scale" src="<?php echo $field['litpic']; ?>" alt="<?php echo $field['title']; ?>" /> </a> 
       </div> 
